...
<section class="vh-100" >
  <div class="container-fluid h-custom"style="padding-left: 80px;">
    <div class="row d-flex justify-content-center align-items-center h-100">
     ...
     style="width:390px" class="img-fluid" alt="Sample image">
      </div>
      <div class="col-md-2 col-lg-6 col-xl-6 offset-xl-2">
        <form >
        <section class="vh-100 gradient-custom">
  <div class="container py- h-100">
    <div class="row justify-content-center align-items-center h-100">
      <div class="col-0 col-lg-0 ">
